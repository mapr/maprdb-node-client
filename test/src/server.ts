...
const InsertOrReplace = (call, callback: (err: Error, data: InsertOrReplaceResponse) => void) => {
...
const CreateTable = (call, callback) => {
  console.log('CreateTable', call.request)
  callback(null, {message: 'Hello ' + call.request.name});
}

const DeleteTable = (call, callback) => {
  console.log('DeleteTable', call.request)
  callback(null, {message: 'Hello ' + call.request.name});
}

const TableExists = (call, callback) => {
