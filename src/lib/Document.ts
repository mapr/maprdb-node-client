...
export class Document {
  ...
  private setODate(field: string, value: any) {
    _.set(this._internalObject, field, value)
    _.set(this._internalJSONObject, field, value.toString())
  }

  private setOTime(field: string, value: any) {
    _.set(this._internalObject, field, value)
    _.set(this._internalJSONObject, field, value.toString())
  }

  private setOTimestamp(field: string, value: any) {
    _.set(this._internalObject, field, value)
    _.set(this._internalJSONObject, field, value.toString())
  }

  private setOInterval(field: string, value: any) {
    _.set(this._internalObject, field, value)
    _.set(this._internalJSONObject, field, value.toString())
  }
}
